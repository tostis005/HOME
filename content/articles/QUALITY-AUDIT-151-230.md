# HOME — Quality audit 151–230

## Result

- JSON checked: **160 / 160** (80 ES + 80 EN expected).
- Structural/editorial validation: **PASS**.
- Targeted field/content fixes applied in final pass: **0**.
...
|---|---|---:|---:|---:|---:|
| #159/#160 | tap-water taste vs metallic taste | 0.019 | 0.253 | 0.018 | 0.324 |
| #162/#163 | burnt pan vs burnt pot | 0.018 | 0.220 | 0.024 | 0.263 |
| #172/#173 | no hot water vs sudden temperature change | 0.022 | 0.159 | 0.018 | 0.173 |
| #179/#181 | pantry moths vs unidentified pantry insects | 0.027 | 0.196 | 0.019 | 0.243 |
| #186/#187 | deodorant stains vs yellow stains on whites | 0.145 | 0.219 | 0.022 | 0.302 |
| #191/#192 | down jacket vs puffer jacket | 0.059 | 0.226 | 0.015 | 0.249 |
| #194/#195 | temporary roof leak repair vs locating roof leak | 0.016 | 0.143 | 0.012 | 0.166 |
| #201/#207 | heater will not start vs heater runs but does not heat | 0.066 | 0.173 | 0.026 | 0.198 |
| #208/#209 | mold on mattress vs mold on carpet | 0.034 | 0.164 | 0.014 | 0.189 |
| #208/#210 | mattress mold vs recurring mold | 0.015 | 0.149 | 0.030 | 0.194 |
| #209/#210 | carpet mold vs recurring mold | 0.023 | 0.145 | 0.013 | 0.215 |
| #211/#224 | opened milk storage vs milk left out | 0.022 | 0.128 | 0.024 | 0.219 |
| #212/#155 | raw ground meat vs cooked ground meat | 0.010 | 0.185 | 0.065 | 0.226 |
| #214/#146 | season cast iron vs clean cast iron | 0.034 | 0.162 | 0.021 | 0.212 |
| #215/#147 | parchment vs foil in air fryer | 0.028 | 0.179 | 0.041 | 0.182 |
| #216/#18 | dryer not drying vs dryer not heating | 0.009 | 0.179 | 0.022 | 0.175 |
| #216/#217 | dryer not drying vs dryer vent cleaning | 0.015 | 0.159 | 0.034 | 0.156 |
| #221/#295 | why washer smells vs future cleaning-a-smelly-washer topic | 0.000 | 0.000 | 0.000 | 0.000 |
...
- No localization heuristic warnings.

## Final editorial reading priorities

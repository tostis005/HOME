...
<section class="archive-hero">
    <div class="container">
        <div class="section-kicker"><?php esc_html_e('Browse HOME', 'home'); ?></div>
...
<div class="container content-grid">
    ...
    <?php else : ?>
        <div class="empty-state" style="grid-column:1/-1"><h1><?php esc_html_e('No guides yet.', 'home'); ?></h1><p><?php esc_html_e('New household guides will appear here as they are published.', 'home'); ?></p></div>
    <?php endif; ?>
</div>
